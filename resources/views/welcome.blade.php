...
<body>
    ...
    <section class="section-container">
        <div class="container py-5 my-5">
            <p class="lead animate-text delay-1" style="padding-bottom: 30px">
                THE WEDDING OF
            </p>
            ...
            <div class="d-flex justify-content-center pb-5">
                <div class="my-5 rounded py-3 px-5 animate-text delay-3">
                    <p class="py-0 my-0">Kepada Yth.</p>
                    <p class="fw-bold py-0 my-0" id="guest-name">Tamu Undangan</p>
                    <p class="py-0 my-0">Ditempat</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-container" style="background-color: var(--secondary-color)" id="invitation">
        <div class="container">
            ...
            <!-- Countdown -->
            <div class="d-flex justify-content-center gap-3 my-4 flex-wrap animate-text delay-3" id="countdown">
                <div>
                    <h3 id="days">0</h3>
                    <small>Days</small>
                </div>
    ...
    <section class="section-container"
      ...
      "
        ...
        <div class="container position-relative">
            <h2 class="section-title animate-text">Save The Date</h2>

            <!-- Akad Nikah -->
            <div class="content-block animate-text delay-2">
                <h3 class="fw-bold fst-italic">Akad Nikah</h3>
            ...
            <!-- Resepsi -->
            <div class="content-block animate-text delay-4">
                <h3 class="fw-bold fst-italic">Resepsi</h3>
                <p class="fw-bold fs-5 mb-1">Sabtu, 7 September 2025</p>
        ...
        <div class="container position-relative">
            ...
            <form id="comment-form" class="mb-4 animate-text delay-1">
                ...
                <div class="mb-2">
                    ...
                    <textarea id="message" class="form-control" maxlength="500" rows="3" required placeholder="Input wish..."></textarea>
    ...
    <!-- Gift Section -->
    <section class="section-container" style="background-image: url('gift-bg).JPG')" id="gift">
        <div class="overlay-bg"></div>
        <div class="container position-relative">
